...
namespace UAT_CREATOR.Controllers
{
    public class UATPackageController : Controller
    {
        ...
        public static void Copy(string sourceDirectory, string targetDirectory, string fileToExclude) {
            DirectoryInfo diSource = new DirectoryInfo(sourceDirectory);
            DirectoryInfo diTarget = new DirectoryInfo(targetDirectory);

            CopyAll(diSource, diTarget, fileToExclude);
        }

        public static void CopyAll(DirectoryInfo source, DirectoryInfo target,string fileToExclude) {
            ...
            foreach (DirectoryInfo diSourceSubDir in source.GetDirectories()) {
                ...
                CopyAll(diSourceSubDir, nextTargetSubDir, fileToExclude);
            }
        }
